...
# --- THE DEFINITIVE, CORRECT PATH SOLUTION ---
# This code determines the absolute path to the directory where this script lives.
# It uses this path to locate the 'static' folder. This is guaranteed to work
# on Render's worker environment as long as the files are in your Git repo.
...
# ... (All helper functions like update_job_progress, download_file, etc., are correct and unchanged) ...
...
def create_reddit_post_image(data, text_chunk, part_num):
    ...
    # This now uses the guaranteed correct path
    ...
    # ... (The rest of the image generation logic is correct and unchanged) ...
